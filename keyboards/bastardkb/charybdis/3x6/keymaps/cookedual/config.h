...
#define SPI_DRIVER SPID0 //copied from freznel, might need to change pins
#define SPI_SCK_PIN GP18 //copied from freznel, might need to change pins
#define SPI_MOSI_PIN GP19 //copied from freznel, might need to change pins
#define SPI_MISO_PIN GP20 //copied from freznel, might need to change pins
