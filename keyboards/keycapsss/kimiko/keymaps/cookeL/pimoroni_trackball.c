...
/* 
 * these two configure the "acceleration" calculations below (in process_mouse()). 
 * the defaults here are what was originally in this code when I found it...
 */
#ifndef PIMORONI_MOUSE_ACCEL
#   define PIMORONI_MOUSE_ACCEL 2
#endif

#ifndef PIMORONI_MOUSE_POWER
#   define PIMORONI_MOUSE_POWER 1.5
#endif
/****/
