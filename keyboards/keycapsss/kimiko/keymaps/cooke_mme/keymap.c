...
// QWERTY
 [_QWERTY] = LAYOUT(   
     ...
     XXXXXXX, KC_Z, KC_X, KC_C, KC_V, KC_B, _______,  _______, KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_ASOFF,
...
// COLEMAK
 [_COLEMAK_DH] = LAYOUT(  
     ...
     XXXXXXX, KC_Z, KC_X, KC_C, KC_D, KC_V,   _______,  _______, KC_K,   KC_H,    KC_COMM, KC_DOT, KC_SLSH, KC_ASOFF,
           XXXXXXX, XXXXXXX, XXXXXXX, THMBLL, THMBLR,   THMBRL,  THMBRR, XXXXXXX, XXXXXXX, XXXXXXX                                        
  ),
