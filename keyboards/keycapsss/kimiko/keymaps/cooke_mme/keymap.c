...
#define SETTNG      MO(_SETTNG)

#define THMBLL      LT(LOWER,KC_SPC)
#define THMBLR      LT(SETTNG,KC_TAB)
#define THMBRL      LT(SETTNG,KC_BSPC)
#define THMBRR      LT(RAISE,KC_ENT)
...
// QWERTY
 [_QWERTY] = LAYOUT(   
     ...
     SWAP_OS, KC_Z, KC_X, KC_C, KC_V, KC_B, _______,  _______, KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_ASOFF,
         XXXXXXX, XXXXXXX, XXXXXXX, THMBLL, THMBLR,   THMBRL,  THMBRR, XXXXXXX, XXXXXXX, XXXXXXX                                    
  ),
...
// COLEMAK
 [_COLEMAK_DH] = LAYOUT(  
     ...
     SWAP_OS, KC_Z, KC_X, KC_C, KC_D, KC_V,   _______,  _______, KC_K,   KC_H,    KC_COMM, KC_DOT, KC_SLSH, KC_ASOFF,
           XXXXXXX, XXXXXXX, XXXXXXX, THMBLL, THMBLR,   THMBRL,  THMBRR, XXXXXXX, XXXXXXX, XXXXXXX                                        
  ),
...
// SETTING & FUNCTION
 [_SETTNG] = LAYOUT(
     ...
     _______, _______, _______, _______, _______, KC_ENT,                    KC_BSPC, KC_F1, KC_F2, KC_3, KC_F11, _______,    
     _______, _______, _______, _______, KC_TAB,  KC_ESC,  _______, _______, _______, KC_F7, KC_F8, KC_9, KC_F12, _______, 
                       XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______
  ),  
