 ...
 * |   [   |   Z  |   X  |   C  |   V  |   B  |---------|    |-------|   N  |   M  |   ,  |   .  |   /  |  ]  |
 * `------------------------------------------| NUMPAD  /     \ SHIFT\----------------------------------------'
 *              | PROCREATE | CAPS| Esc | Tab | Space  /       \ Enter\ BackSP | Del | MAUS |GAMING|
 *              `-------------------------------------'         '-----------------------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
    ...
    KC_LBRC, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B, KC_LEAD,             KC_GRV, KC_N, KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         KC_RBRC,
 ...
 */
 ...
 [_GAMING] = LAYOUT(
    ...
    LALT_T(KC_LBRC), KC_Z, KC_X,    KC_C,    KC_V,    KC_B, KC_LEAD,                           KC_GRV, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RALT_T(KC_RBRC),
                         PROCREATE, KC_ESC, KC_LGUI, LCTL_T(KC_DEL), LT(LOWER,KC_SPC), LT(RAISE,KC_ENT), RCTL_T(KC_BSPC), RGUI_T(KC_DEL), MAUS, GAMING
  )
 };
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    /*if (layer_state_cmp(state, _GAMING)) {   //removed just in case something is wrong above
