...
//   #define KIMIKO_AUTO_POINTER_LAYER_TRIGGER_THRESHOLD 8
//   #define KIMIKO_AUTO_POINTER_LAYER_TRIGGER_TIMEOUT_MS 1000
   #define KIMIKO_AUTO_POINTER_LAYER_TRIGGER_ENABLE
